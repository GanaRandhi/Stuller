...
using MyPoki.Repository.Cache;
using MyPoki.Repository.Models;

namespace MyPoki.Repository
{
    public class MyPokeApiClient : IDisposable
    {
        /// <summary>
        /// The default `User-Agent` header value used by instances of <see cref="MyPokeApiClient"/>.
        /// </summary>
        ...
        /// Default constructor
        /// </summary>
        public MyPokeApiClient() : this(DefaultUserAgent) {}

        /// <summary>
        /// Initializes a new instance of the <see cref="MyPokeApiClient"/> with 
        /// a given value for the `User-Agent` header
        /// </summary>
        /// <param name="userAgent">The value for the default `User-Agent` header.</param>
        public MyPokeApiClient(ProductHeaderValue userAgent)
        {
            if (userAgent == null)
            {
        ...
        public MyPokeApiClient(HttpMessageHandler messageHandler)
        ...
        /// <param name="messageHandler">Message handler implementation</param>
        /// <param name="userAgent">The value for the default `User-Agent` header.</param>
        public MyPokeApiClient(HttpMessageHandler messageHandler, ProductHeaderValue userAgent)
        {
            if (userAgent == null)
            {
                throw new ArgumentNullException(nameof(userAgent));
        ...
        public MyPokeApiClient(HttpClient httpClient)
        {
        ...
        {
            var version = typeof(MyPokeApiClient).Assembly.GetName().Version;
